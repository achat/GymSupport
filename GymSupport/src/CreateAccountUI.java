...
public class CreateAccountUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{   
        sutj.saveUserToJson(jTextField1.getText(),jTextField5.getText(),jTextField2.getText(),jTextField6.getText(),Integer.parseInt(jTextField3.getText()),jTextField7.getText(),Integer.parseInt(jTextField4.getText()),Integer.parseInt(jTextField8.getText()),jTextField9.getText());
